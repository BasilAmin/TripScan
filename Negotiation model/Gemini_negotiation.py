...
gemini_api_key = "AIzaSyAsSlJGSZOLQcGD1OtuEabCNYYGXZdK6k8"

client = gemenai.Client(api_key=gemini_api_key)

prompt_instructions = """ You are given a chat, in where 2 or more users are discussing and attempting to settle on a travel date
...
people, based on information they have provided in the chat to select a time of travel. """
